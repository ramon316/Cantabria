...
export default {
        ...
        methods:{
                eliminarPrecio: function(){
                        ...
                        this.$swal({
                                title: '¿Estas seguro que deseas eliminar este precio?',
                                ...
                                cancelButtonText: 'No lo elimines',
                                        ...
                                        if (result.isConfirmed) {
                                                ...
                                                axios.post(`/precios/${this.precioId}`,{params, _method: 'delete'})
                                                //axios funciona con promises
                                                .then(respuesta => {
                                                        //esta es nuestra conformación
                                                        this.$swal({
                                                                title: 'Eliminar Precio',
                                                                text: 'El Precio ha sido eliminado',
                                                                icon: 'success',
                                                })
