...
<body>
    ...
    <div class="pagina">
        ...
        <div class="row primeralinea">
            <label><strong>VIGÉSIMA.-</strong> EL ARRENDADOR utiliza como refresco la marca de
    ...
    <div class="pagina">
        ...
        <div class="row primeralinea">
            <label><strong>VIGÉSIMA SEXTA.-</strong> Para todo lo relativo a la
