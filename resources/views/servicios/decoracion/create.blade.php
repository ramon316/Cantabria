...
@section('title', 'Servicio Decoración')

@section('content_header')
<div class="container">
    <h1 class="text-center">Agregar Servicio de Decoración</h1>
</div>
@stop
...
<form method="POST" action="{{ route('servicio.store') }}" novalidate>
        ...
        <div class="form-group">
          <label for="">Días del servicio</label>
            <select class="form-control
                    @error('dias') is-invalid @enderror"
                    value="{{old('dias')}}"
                    name="dias"
                    >
    ...
    <div class="form-group">
      <input type="hidden" name="servicio" value="decoracion">
    </div>
